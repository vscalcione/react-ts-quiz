...
function makeQueryCache(_temp) {
  ...
  function makeQuery(_ref5) {
    ...
    var tryFetchData = _async(function (fn) {
        ...
        if (fetchMore) {
          queryFn = _async(function () {
            ...
            return _finallyRethrows(function () {
              ...
              return _rethrow(_wasThrown, _result5);
            });
          });
        }
    ...
    if (query.config.infinite) {
      query.fetchMore = function (fetchMoreInfo, _temp6) {
        if (fetchMoreInfo === void 0) {
          fetchMoreInfo = query.state.canFetchMore;
        }

        var _ref7 = _temp6 === void 0 ? {} : _temp6,
            _ref7$previous = _ref7.previous,
            previous = _ref7$previous === void 0 ? false : _ref7$previous;
    ...
    return _catch$1(function () {
      ...
      return _await$1(config.onMutate(variables), function (_config$onMutate) {
        ...
        return _await$1(getMutationFn()(variables), function (data) {
          ...
          return _await$1(config.onSuccess(data, variables), function () {
            return _await$1(onSuccess(data, variables), function () {
              return _await$1(config.onSettled(data, null, variables), function () {
                return _await$1(onSettled(data, null, variables), function () {
                  return data;
                });
              });
            });
      ...
      Console.error(error);
      return _await$1(config.onError(error, variables, snapshotValue), function () {
        return _await$1(onError(error, variables, snapshotValue), function () {
          return _await$1(config.onSettled(undefined, error, variables, snapshotValue), function () {
            return _await$1(onSettled(undefined, error, variables, snapshotValue), function () {
              if (isLatest()) {
                dispatch({
                  type: actionReject,
                  error: error
...
export { ReactQueryCacheProvider, ReactQueryConfigProvider, deepIncludes, makeQueryCache, queryCache, queryCaches, setConsole, setFocusHandler, stableStringify, statusError, statusIdle, statusLoading, statusSuccess, useInfiniteQuery, useIsFetching, useMutation, usePaginatedQuery, useQuery, useQueryCache };
